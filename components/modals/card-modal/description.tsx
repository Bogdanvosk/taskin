      ...
      <div className="w-full">
        ...
        {isEditing ? (
          ...
          <div
            ...
            role="button"
            className="min-h-[78px] bg-neutral-200 dark:bg-slate-500/80 dark:hover:bg-slate-700 rounded-md text-sm font-medium py-3 px-3.5 hover:bg-neutral-300 transition"
          >
